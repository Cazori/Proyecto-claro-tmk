...
import CleoAvatar from './chat/CleoAvatar';
        ...
        <aside className={`sidebar ${isSidebarOpen ? 'open' : 'closed'}`}>
            <div className="logo-area">
                ...
                <div className="logo-text">
                    ...
                    <div style={{ fontSize: '10px', color: '#6B7280', marginTop: '2px' }}>v1.9.3</div>
                </div>
            </div>
            ...
            <nav className="nav-menu">
                ...
                <button className={`nav-btn ${activeTab === 'sales' ? 'active' : ''}`} onClick={() => setActiveTab('sales')}>
                    ...
                    <span className="nav-label">Ventas Asesor</span>
                </button>
                <button className={`nav-btn ${activeTab === 'expert' ? 'active' : ''}`} onClick={() => setActiveTab('expert')}>
                    ...
                    <span className="nav-label">Enseñale a Cleo</span>
                </button>
            </nav>
        </aside>
    );
